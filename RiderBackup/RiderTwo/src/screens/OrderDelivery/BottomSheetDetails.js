...
const BottomSheetDetails = (props) => {
    ...
    const isDriverClose = totalKm <= 0.5; // decrease for higher accuracy

    const { order, user, restaurant, dishes, acceptOrder, completeOrder, pickUpOrder } =
    useOrderContext();
    ...
    return (
            ...
            >
                ...
                <View style={styles.deliveryDetailsContainer}>
                    ...
                    <Text style={styles.adressText}>{restaurant?.address}</Text>
                    </View>
                    ...
                    <View style={styles.adressContainer}>
                    <FontAwesome5 name="coins" size={30} color="grey" />
                    <Text style={styles.adressText}>Rs. {order.total.toFixed(2)}</Text>
                    </View>

                    <View style={styles.adressContainer}>
                    <FontAwesome5 name="phone" size={30} color="grey" />
                    <Text style={styles.adressText}>{user?.telno}</Text>
                    </View>
